...
import { IState, toHome, clearTokenLogout, toEditQuery } from "../state";
  ...
  return (
    <Stack horizontalAlign="center" verticalAlign="center" styles={stackStyles}>
      ...
      <ActionButton
        ...
        onClick={errorMessage === API_ERROR_MESSAGE ? props.toHome : errorMessage === BAD_QUERY_MESSAGE ? props.toEditQuery : props.clearTokenLogout}
      />
    </Stack>
  );
}
